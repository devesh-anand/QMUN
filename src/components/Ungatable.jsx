...
export default function Ungatable({ heading, data, c1, c2, c3 }) {
  return (
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Portfolios marked in red are already alloted and can <b>not</b> be
            opted for. <br />
            Make sure to recheck this matrix before final submission of your
            choices in google form.
          </p>
        </div>
      </div>
